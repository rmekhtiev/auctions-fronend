    ...
    >
      <form @submit.prevent="submit()">
        <div class="flex flex-wrap">
          ...
          <button
            type="submit"
            class="bg-gray-500 bg-gray-800 hover:text-white hover:bg-black block w-full px-6 py-3 mt-3 text-lg font-semibold text-white transition duration-150 border-2 border-transparent rounded-lg focus:border-gray-600 focus:outline-none"
          >
            Продолжить
          </button>
        </div>
