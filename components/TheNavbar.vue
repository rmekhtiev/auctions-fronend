          ...
          <div class="hidden sm:block sm:ml-6">
            <div class="flex">
              <nuxt-link
                ...
                :to="item.to"
                :class="{ 'ml-4': index !== 0 }"
                class="px-3 py-2 rounded-md text-sm font-medium leading-5 text-gray-300 hover:text-white hover:bg-gray-700 focus:outline-none focus:text-white focus:bg-gray-700 transition duration-150 ease-in-out"
              >
                {{ item.title }}
              </nuxt-link>
            </div>
